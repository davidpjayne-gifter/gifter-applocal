...
const EXPLORE_CARDS: ExploreCard[] = [
  ...
  { label: "🏡 For the Home", href: "/explore/for-the-home" },
];
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            <div className="w-full max-w-md rounded-2xl border border-slate-300 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900">
              ...
              <div className="mt-3 space-y-3 text-sm text-slate-600 dark:text-slate-300">
                ...
                <p className="font-semibold text-slate-900 dark:text-slate-50">👥 Add people &amp; gifts</p>
                <p>
                  Add the people you’re buying for, then add gifts under each person. For every gift,
                  you can track 🎁 what it is, 💵 the cost, and 📦 an optional tracking number.
                </p>
                <p className="font-semibold text-slate-900 dark:text-slate-50">📊 See everything at a glance</p>
                ...
                <p className="font-semibold text-slate-900 dark:text-slate-50">✅ Track progress as you go</p>
                <p>
                  As gifts are wrapped or arrive, update their status so you always know what’s left
                  to do - and when you’re done GIFTing.
                </p>
              </div>
              <button
                type="button"
