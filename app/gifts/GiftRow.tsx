        ...
        {!isEditing ? (
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              disabled={saving}
              className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-900 focus:border-slate-400 focus:outline-none disabled:bg-slate-100"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  disabled={saving}
                  inputMode="decimal"
                  className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-900 focus:border-slate-400 focus:outline-none disabled:bg-slate-100"
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                disabled={saving}
                className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-slate-300 disabled:cursor-not-allowed disabled:bg-slate-100"
              >
                Cancel
              </button>
            </div>
