                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center">
                          <div className="inline-flex items-center justify-center rounded-none border border-blue-200 bg-white px-3 py-2 text-slate-900 dark:border-blue-300/30 dark:bg-slate-950">
